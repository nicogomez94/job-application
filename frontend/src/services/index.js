...
export const authService = {
  ...
  resendEmailVerification: (data) => api.post('/auth/resend-verification', data),
...
export const psychologistRequestService = {
  send: (psychologistId, message) => api.post('/psychologists/requests', { psychologistId, message }),
  ...
  getContactInfo: (psychologistId) => api.get(`/psychologists/${psychologistId}/contact`),
};
